...
final class JeuControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'jeu[nom]' => 'Testing',
            'jeu[nbParticipant]' => 'Testing',
            'jeu[evenement]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setNbParticipant('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setNbParticipant('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'jeu[nbParticipant]' => 'Something New',
            'jeu[evenement]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNbParticipant());
